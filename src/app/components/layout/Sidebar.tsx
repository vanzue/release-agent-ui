...
import { Home, Activity, GitBranch, FileText, CheckSquare, Archive, Flame, Layers, Search, RefreshCcw, Clock3 } from 'lucide-react';
...
export function Sidebar() {
  ...
  const mainNavItems = [
    ...
    { to: '/issues/recent', icon: Clock3, label: 'Recent Issues' },
    { to: '/issues/search', icon: Search, label: 'Issue Search' },
    { to: '/issues/sync-admin', icon: RefreshCcw, label: 'Issue Sync Admin' },
  ];
